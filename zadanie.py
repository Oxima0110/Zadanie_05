    ...
    while True:
        if gamer == name_player_1:
            ...
            if board[ind_1][ind_2] == ' ':
                ...
                draw_board_2(board)
                if get_viner(board):
                    advertisement = 'У нас есть победитель!'
                    advertisement_1 = gamer
                    return advertisement, advertisement_1
                gamer = name_player_2           
        else:
            ...
            if board[ind_1][ind_2] == ' ':
                ...
                gamer = name_player_1        
        if get_draw(board):
            advertisement = 'У нас ничья.'
            advertisement_1 = 'Game Over.'
            return advertisement, advertisement_1
...
draw_board_2(playing_field)
play_game(gamer_int, name_0, name_1, mark_0, mark_1, playing_field)
text_output, text_output_1 = play_game(gamer_int, name_0, name_1, mark_0, mark_1, playing_field)
print(text_output, text_output_1)